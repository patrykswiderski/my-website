...
function About() {
  return (
    <div className='text-gray-600 bg-gray-200 lg:rounded-2xl max-w-[1200px] mx-auto my-8' id='about'>
        ...
        <div className='md:grid md:grid-cols-2 sm:py-16'>
            ...
            <img src='/photo.jpg' className='hidden md:block mx-auto md:rounded-2xl py-8 md:py-0 lg:shadow-sm shadow-gray-500 h-[320px]' alt='photo'/>
        </div>
    </div>
  )
}
