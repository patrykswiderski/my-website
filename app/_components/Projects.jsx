  ...
  return (
    <div className='max-w-[1200px] mx-auto p-5' id='projects'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-2 gap-6'>
            <div className='transform transition-transform duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-gray-500 group container rounded-md flex justify-center items-center mx-auto content-div h-auto bg-cover relative'>
