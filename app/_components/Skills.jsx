...
function Skills() {
  return (
    <div className='bg-gray-200 text-gray-600 lg:rounded-2xl md:h-[180px] max-w-[1200px] mx-auto my-8 pb-4 md:pt-2 md:pb-2 grid grid-cols-4 place-items-center md:flex md:justify-between md:items-center' id='skills'>
